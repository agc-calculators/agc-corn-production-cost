...
class AgcCornProductionCostInputs {
    constructor() {
        this.socket = "";
        this.ready = false;
    }
    render() {
        return (h("section", { "data-wizard-results": true, ref: c => this.section = c },
            ...
            h("div", { style: { display: this.ready ? 'block' : 'none' } }, this.data && (h("ul", { class: "agc-results" },
                h("li", null,
                    h("h2", { "data-i18n": "results.corn-market-price" }, "Estimated Corn Market Price"),
                    h("span", { class: "agc-results__value" },
                        "$",
                        parseMoney(this.data['cornMarketPrice']).dollars),
                    h("sub", null,
                        h("strong", null,
                            ".",
                            parseMoney(this.data['cornMarketPrice']).cents))),
                h("li", null,
                ...
                h("li", null,
                    h("h2", { "data-i18n": "results.corn-on-corn-yield" }, "Expected Yield"),
    ...
    static get is() { return "agc-corn-production-cost-inputs"; }
...
export { AgcCornProductionCostInputs };
